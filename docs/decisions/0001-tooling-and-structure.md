...
| 2   | npm scope                | **`@sm-lab/*`** (org scope, not lidofinance) | unscoped; `@lidofinance/*`                | own namespace; `csm-cl-mock` keeps its `bin`, old package deprecated                                                                                                                                                                                  |
...
| 9   | Shared internals         | **harvested into `@sm-lab/core`, bundled**   | design upfront; publish separately        | extract only proven duplication; self-contained consumers                                                                                                                                                                                             |
